...
unsigned char *MD5::raw_digest(){
  ...
  if (!finalized){
    throw string("MD5::raw_digest:  Can't get digest if you haven't finalized the digest!");
  }
...
char *MD5::hex_digest(){
  ...
  if (!finalized){
    throw string("MD5::hex_digest:  Can't get digest if you haven't finalized the digest!");
  }
